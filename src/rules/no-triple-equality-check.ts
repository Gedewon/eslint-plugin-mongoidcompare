...
const createRule = ESLintUtils.RuleCreator(
  name =>
    `https://github.com/Gedewon/eslint-plugin-mongoidcompare/blob/main/doc.md`,
)
...
const isBothSideMongoIdTypes = (
  leftNodeType: ts.Type,
  rightNodeType: ts.Type,
...
> = createRule({
  create(
    context: Readonly<TSESLint.RuleContext<'noTripleEqualityCheck', never[]>>,
  ) {
    return {
